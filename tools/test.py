...
def parse_config():
    ...
    parser.add_argument('--ckpt', type=str, default='/space/userfiles/alyaqou1/det3d/output/pv_rcnn_plusplus/2023_late_summer_5min_balanced/ckpt/checkpoint_epoch_80.pth', help='checkpoint to start from')
