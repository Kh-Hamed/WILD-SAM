...
class FourSeasonDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None):
        ...
        info_path_T0 = '/space/userfiles/khatouna/OpenPCDet_WOD_DA_FS/output_baseline_seasons/voxel_rcnn/2023_late_summer_5min_balanced/eval/epoch_80/train/2023_snow_5min_balanced/result.pkl'
