...
class FourSeasonDataset(DatasetTemplate):
    ...
    def create_groundtruth_database(self, info_path, save_path, used_classes=None, split='train', sampled_interval=10,
        ...
        db_info_save_path = save_path / ('%s_pseudo_dbinfos_%s_sampled_%d.pkl' % (processed_data_tag, split, sampled_interval))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg_file', type=str, default='/space/userfiles/khatouna/OpenPCDet_WOD_DA_FS/tools/cfgs/dataset_configs/fourseason_dataset.yaml', help='specify the config of dataset')
    parser.add_argument('--func', type=str, default='create_fs_gt_database', help='')
