...
def create_fs_gt_database(
    ...
    train_split = 'train'
    train_filename = '/space/userfiles/khatouna/SAM_IV_conference/data/LISA/snow_20_mm_hr/fs_infos_train.pkl'
...
if __name__ == '__main__':
    ...
    ROOT_DIR = Path('/space/userfiles/khatouna/SAM_IV_conference/data/LISA/snow_20_mm_hr')
